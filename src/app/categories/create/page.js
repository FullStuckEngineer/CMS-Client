...
const CategoryCreatePage = () => {
    ...
    const handleCreateCategory = async () => {
        ...
        try {
            ...
            await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL_API}/cms/categories`, newCategory, {
                headers: {
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4 justify-center flex">Create New Category</h1>
